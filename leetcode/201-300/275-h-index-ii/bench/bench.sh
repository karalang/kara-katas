#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #275.
...
bench_begin id=275 slug=h-index-ii group=201-300 \
    title="H-Index II" \
    workload="build one 262,144-element sorted citation array once, then run 6,000,000 h-index binary searches over prefixes of varying length; sink = folded answers" sink="$expected"
