...
bench_begin id=203 slug=remove-linked-list-elements group=201-300 \
    title="Remove Linked List Elements" \
    workload="relink + remove + survivor-sum over 40K passes on a 3000-node index-pool list (pointer-chase kernel)" sink="$expected"
