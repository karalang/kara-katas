...
bench_begin id=219 slug=contains-duplicate-ii group=201-300 \
    title="Contains Duplicate II" \
    workload="value->last-index hash map counting nearby duplicates over a 1M PRNG array, swept for k in 1..40; sum of hits" sink="$expected"
