#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #266.
...
bench_begin id=266 slug=palindrome-permutation group=201-300 \
    title="Palindrome Permutation" \
    workload="build one 200,000-element lowercase byte array once, then 4000 rounds of the histogram parity test over a rotating window; sink = folded odd-counts and verdicts" sink="$expected"
