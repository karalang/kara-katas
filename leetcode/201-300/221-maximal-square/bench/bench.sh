#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #221.
...
bench_begin id=221 slug=maximal-square group=201-300 \
    title="Maximal Square" \
    workload="1-D DP maximal square, 800x800 grid x 150 passes" sink="$expected"
