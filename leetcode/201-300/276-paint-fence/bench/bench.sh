#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #276.
...
bench_begin id=276 slug=paint-fence group=201-300 \
    title="Paint Fence" \
    workload="enumerate all 4^13 paintings of 13 posts, reject three-in-a-row; sink = the count, which must equal the DP answer 36884484" sink="$expected"
