...
bench_begin id=229 slug=majority-element-ii group=201-300 \
    title="Majority Element II" \
    workload="two-candidate Boyer-Moore vote + verify over a width-16 sliding window across a 3M LCG array (branchy, loop-carried counts)" sink="$expected"
