...
bench_begin id=211 slug=design-add-and-search-words-data-structure group=201-300 \
    title="Design Add and Search Words Data Structure" \
    workload="build a 20k-word index-pool trie once, then match 8M PRNG wildcard patterns via backtracking DFS; sink = count of matches" sink="$expected"
