...
bench_begin id=231 slug=power-of-two group=201-300 \
    title="Power of Two" \
    workload="is_power_of_two over a 130M-step LCG stream, masked to 0..1024 (loop-carried PRNG, count of powers)" sink="$expected"
