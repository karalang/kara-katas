...
bench_begin id=225 slug=implement-stack-using-queues group=201-300 \
    title="Implement Stack using Queues" \
    workload="PRNG-driven push/pop/top sequence on the queue-backed stack (O(n) costly-push rotations)" sink="$expected"
