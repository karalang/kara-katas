...
bench_begin id=273 slug=integer-to-english-words group=201-300 \
    ...
    workload="build 200,000 integers once, then spell all of them with the star three-digit chunker 5 times; sink = folded bytes of every spelling" sink="$expected"
