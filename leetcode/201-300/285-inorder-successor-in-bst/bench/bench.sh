#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #285.
...
bench_begin id=285 slug=inorder-successor-in-bst group=201-300 \
    title="Inorder Successor in BST" \
    workload="300k-node randomly-built BST, 2M successor queries mixing present and absent keys; sink folds the Option with absent collapsed to -1" sink="$expected"
