#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #299.
...
bench_begin id=299 slug=bulls-and-cows group=201-300 \
    title="Bulls and Cows" \
    workload="build 400k secret/guess pairs once over a 4-digit alphabet, then 12 scoring passes; sink = polynomial hash of every xAyB verdict" sink="$expected"
