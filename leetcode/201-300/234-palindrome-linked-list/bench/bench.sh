...
bench_begin id=234 slug=palindrome-linked-list group=201-300 \
    title="Palindrome Linked List" \
    workload="is_palindrome (midpoint + in-place reverse + compare) over a 50k-node list, 1800 passes with a middle-value punch" sink="$expected"
