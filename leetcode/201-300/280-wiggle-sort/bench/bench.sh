#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #280.
...
bench_begin id=280 slug=wiggle-sort group=201-300 \
    title="Wiggle Sort" \
    workload="30 rounds of the O(n) greedy over a 2M-element array, each round refreshed from the source; sink = positional hash of every result" sink="$expected"
