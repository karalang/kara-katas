#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #260.
...
bench_begin id=260 slug=single-number-iii group=201-300 \
    title="Single Number III" \
    workload="4 arrays of 200,002 i64 built once (100k values repeated twice + two loners), then 2600 punches of the two-pass XOR partition; sink=573145098" sink="$expected"
