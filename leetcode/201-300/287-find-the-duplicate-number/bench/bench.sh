#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #287.
...
bench_begin id=287 slug=find-the-duplicate-number group=201-300 \
    title="Find the Duplicate Number" \
    workload="4 arrays of 200,001 i64 built once, each encoding a single shuffled n-cycle so Floyd's walk is ~3n dependent random loads over 1.6 MB; 80 punches; sink=211269409" sink="$expected"
