...
bench_begin id=212 slug=word-search-ii group=201-300 \
    title="Word Search II" \
    workload="build a 4k-word trie once, then run the trie-guided 12x12 board DFS over 40k fresh PRNG boards; sink = traversal checksum" sink="$expected"
