...
bench_begin id=220 slug=contains-duplicate-iii group=201-300 \
    title="Contains Duplicate III" \
    workload="bucketed sliding-window check over one PRNG array across many (k,t) pairs (map-heavy, data-dependent early exit)" sink="$expected"
