...
bench_begin id=228 slug=summary-ranges group=201-300 \
    title="Summary Ranges" \
    workload="numeric summary-ranges scan (ranges + endpoint sum) over a 1M strictly-increasing LCG array, 250 passes" sink="$expected"
