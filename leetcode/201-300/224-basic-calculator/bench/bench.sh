...
bench_begin id=224 slug=basic-calculator group=201-300 \
    title="Basic Calculator" \
    workload="calculate() over one big PRNG +/-/paren expression run K times (byte-scan + stack, data-dependent branch)" sink="$expected"
