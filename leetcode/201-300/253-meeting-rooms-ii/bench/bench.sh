#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #253.
...
bench_begin id=253 slug=meeting-rooms-ii group=201-300 \
    title="Meeting Rooms II" \
    workload="build 150k overlapping intervals once and shuffle, then 25 rounds of sort + min-heap room counting; sink = accumulated peak-room checksum" sink="$expected"
