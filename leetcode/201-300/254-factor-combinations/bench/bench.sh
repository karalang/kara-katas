#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #254.
...
bench_begin id=254 slug=factor-combinations group=201-300 \
    title="Factor Combinations" \
    workload="sweep n=2..150000 once, generating every factor combination by sqrt-bounded backtracking; sink = order-independent summed hash of all combinations" sink="$expected"
