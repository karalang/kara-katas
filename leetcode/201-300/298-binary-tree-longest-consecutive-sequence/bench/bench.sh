#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #298.
...
bench_begin id=298 slug=binary-tree-longest-consecutive-sequence group=201-300 \
    title="Binary Tree Longest Consecutive Sequence" \
    workload="build one 2M-node tree, then 40 full passes computing the longest consecutive downward path; sink = polynomial hash of every pass's answer" sink="$expected"
