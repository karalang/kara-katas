...
bench_begin id=296 slug=best-meeting-point group=201-300 \
    title="Best Meeting Point" \
    workload="build 400 128x128 grids once, then 30 median-solve passes; sink=summed minimum totals" sink="$expected"
