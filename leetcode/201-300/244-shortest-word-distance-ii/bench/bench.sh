#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #244.
...
bench_begin id=244 slug=shortest-word-distance-ii group=201-300 \
    title="Shortest Word Distance II" \
    workload="build a 20,000-word list over a 256-word vocabulary and index it ONCE (word -> ascending positions, index-pool construction), then 200,000 punches of the two-pointer merge query over distinct vocabulary pairs; sink is a rolling polynomial hash of the distances" sink="$expected"
