...
static int64_t min_area(int64_t x, int64_t y) {
    int64_t top = first_black_row(0, x + 1);
    int64_t bottom = first_white_row(x + 1, H);
    int64_t left = first_black_col(0, y + 1);
    int64_t right = first_white_col(y + 1, W);
