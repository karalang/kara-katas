...
bench_begin id=218 slug=the-skyline-problem group=201-300 \
    title="The Skyline Problem" \
    workload="divide-and-conquer skyline over 24000 PRNG buildings, 100 build-once+punch re-runs; sum of x+h over all key points (allocation-heavy)" sink="$expected"
