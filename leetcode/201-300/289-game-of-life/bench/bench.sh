#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #289.
...
bench_begin id=289 slug=game-of-life group=201-300 \
    title="Game of Life" \
    workload="256x256 board at 35% density, 60 generations with the two-bit in-place encoding; sink is the final population plus a position-weighted hash" sink="$expected"
