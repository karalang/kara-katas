#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #269.
...
bench_begin id=269 slug=alien-dictionary group=201-300 \
    title="Alien Dictionary" \
    workload="build a flat corpus of 20,000 word lists once, then 60 rounds of Kahn ordering over all of them; sink = folded per-list orders" sink="$expected"
