...
bench_begin id=215 slug=kth-largest-element-in-an-array group=201-300 \
    title="Kth Largest Element in an Array" \
    workload="quickselect (Lomuto) run 420x, array of 120k rebuilt from the PRNG stream each pass; sum of k-th largest values" sink="$expected"
