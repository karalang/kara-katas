...
bench_begin id=209 slug=minimum-size-subarray-sum group=201-300 \
    title="Minimum Size Subarray Sum" \
    workload="one 200k positive-int array built once; run the O(n) sliding window for 290 targets (data-dependent shrink loop); sink = sum of answers" sink="$expected"
