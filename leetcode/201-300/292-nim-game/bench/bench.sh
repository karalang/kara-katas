#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #292.
...
bench_begin id=292 slug=nim-game group=201-300 \
    title="Nim Game" \
    workload="build the win/lose table to n=20,000,000 (the derivation behind the O(1) closed form); sink is the losing-position count plus a positional checksum" sink="$expected"
