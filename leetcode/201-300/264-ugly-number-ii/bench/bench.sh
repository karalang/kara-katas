#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #264.
...
bench_begin id=264 slug=ugly-number-ii group=201-300 \
    title="Ugly Number II" \
    workload="12,000 punches of nth_ugly with n cycling over [9000, 12000) — a fresh growable Vec per call, so half merge-pointer arithmetic and half Vec growth; sink=369380900" sink="$expected"
