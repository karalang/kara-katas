#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #272.
...
bench_begin id=272 slug=closest-binary-search-tree-value-ii group=201-300 \
    title="Closest Binary Search Tree Value II" \
    workload="build one 30,000-node BST and 100,000 f64 targets once, then answer the k=8 closest query for every target 10 times through hoisted iterator stacks; sink = folded returned values" sink="$expected"
