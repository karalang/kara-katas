...
bench_begin id=216 slug=combination-sum-iii group=201-300 \
    title="Combination Sum III" \
    workload="ascending-digit backtracking count over digits 1..36, summed across a k in 1..6 x n in 1..150 grid" sink="$expected"
