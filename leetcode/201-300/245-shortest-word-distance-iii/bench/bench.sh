#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #245.
...
bench_begin id=245 slug=shortest-word-distance-iii group=201-300 \
    title="Shortest Word Distance III" \
    workload="build a 20,000-word list over a 256-word vocabulary once, then 2,000 punches of the unified one-pass scan, alternating same-word and different-word queries; sink is a rolling polynomial hash of the distances" sink="$expected"
