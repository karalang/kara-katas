#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #267.
...
bench_begin id=267 slug=palindrome-permutation-ii group=201-300 \
    title="Palindrome Permutation II" \
    workload="build one 8-pair multiset once, then 44 rounds of the half-backtracking generator with a rotating middle character; each round enumerates 40,320 palindromes; sink = folded string hash and count" sink="$expected"
