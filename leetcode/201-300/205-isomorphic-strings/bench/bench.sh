...
bench_begin id=205 slug=isomorphic-strings group=201-300 \
    title="Isomorphic Strings" \
    workload="is_isomorphic (two-map bijection) over 600K sliding width-200 windows (version-stamped map kernel)" sink="$expected"
