#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #271.
...
bench_begin id=271 slug=encode-and-decode-strings group=201-300 \
    title="Encode and Decode Strings" \
    workload="build one 50,000-string flat corpus once, then 250 rounds of encode+decode through hoisted byte buffers; sink = folded decoded lengths and byte checksum" sink="$expected"
