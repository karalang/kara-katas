...
bench_begin id=222 slug=count-complete-tree-nodes group=201-300 \
    title="Count Complete Tree Nodes" \
    workload="O(log^2 n) spine-height count_nodes over every subtree of a built complete tree (pointer-chasing recursion)" sink="$expected"
