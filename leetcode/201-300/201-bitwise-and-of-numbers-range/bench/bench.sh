...
bench_begin id=201 slug=bitwise-and-of-numbers-range group=201-300 \
    title="Bitwise AND of Numbers Range" \
    workload="range_and over 20M PRNG [lo,hi] pairs (data-dependent bit-shift kernel)" sink="$expected"
