#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #293.
...
bench_begin id=293 slug=flip-game group=201-300 \
    title="Flip Game" \
    workload="40,000 boards of length 64 at three '+' densities (15/50/85%), enumerating one-move successors; sink is the total state count plus a length checksum" sink="$expected"
