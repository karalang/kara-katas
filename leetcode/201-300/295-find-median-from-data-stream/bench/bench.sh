#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #295.
...
bench_begin id=295 slug=find-median-from-data-stream group=201-300 \
    title="Find Median from Data Stream" \
    workload="2M streamed adds, median read after every add via two heaps; sink = polynomial hash of the doubled median (exact integer)" sink="$expected"
