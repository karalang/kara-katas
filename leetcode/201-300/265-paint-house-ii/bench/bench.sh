#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #265.
...
bench_begin id=265 slug=paint-house-ii group=201-300 \
    title="Paint House II" \
    workload="build one 4000x32 cost matrix once, then 1300 rounds of the O(n*k) min/second-min DP with a rotating row offset; sink = folded per-round answers" sink="$expected"
