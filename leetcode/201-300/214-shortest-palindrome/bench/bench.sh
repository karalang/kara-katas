...
bench_begin id=214 slug=shortest-palindrome group=201-300 \
    title="Shortest Palindrome" \
    workload="KMP prefix-function (lps) over 259488 sliding windows of a binary-alphabet string; loop-carried failure-fallback kernel" sink="$expected"
