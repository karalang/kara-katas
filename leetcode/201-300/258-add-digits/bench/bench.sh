#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #258.
...
bench_begin id=258 slug=add-digits group=201-300 \
    title="Add Digits" \
    workload="sweep 10M LCG-drawn i64 values through the % 10 digital-root simulation; sink = accumulated digital roots" sink="$expected"
