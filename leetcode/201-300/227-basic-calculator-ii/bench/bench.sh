...
bench_begin id=227 slug=basic-calculator-ii group=201-300 \
    title="Basic Calculator II" \
    workload="calculate() over one big PRNG +-*/ expression run K times (precedence term-stack, truncating div)" sink="$expected"
