#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #247.
...
bench_begin id=247 slug=strobogrammatic-number-ii group=201-300 \
    title="Strobogrammatic Number II" \
    workload="generate every strobogrammatic number of length 16 (312,500 strings) and re-verify each by the two-pointer rotation check, 12 rounds; sink = checksum over every generated string" sink="$expected"
