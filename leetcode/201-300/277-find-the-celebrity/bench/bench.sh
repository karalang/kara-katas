#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #277.
...
bench_begin id=277 slug=find-the-celebrity group=201-300 \
    title="Find the Celebrity" \
    workload="64 independent celebrity instances at n=2.5M with a formula-based knows(); sink = order-invariant sum of (instance*1000003 + found)" sink="$expected"
