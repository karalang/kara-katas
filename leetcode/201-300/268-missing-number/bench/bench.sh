#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #268.
...
bench_begin id=268 slug=missing-number group=201-300 \
    title="Missing Number" \
    workload="4 arrays of 1,000,000 i64 built once (a permutation of [0,n] minus one value, written at stride-coprime positions), then 850 punches of the XOR fold; sink=434228253" sink="$expected"
