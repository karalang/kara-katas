...
bench_begin id=202 slug=happy-number group=201-300 \
    title="Happy Number" \
    workload="is_happy (Floyd + digit-square-sum) over 1..4M starts (data-dependent div/branch kernel)" sink="$expected"
