#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #250.
...
bench_begin id=250 slug=count-univalue-subtrees group=201-300 \
    title="Count Univalue Subtrees" \
    workload="build one 2M-node level-order tree once from a 3-value alphabet, then 40 full post-order counting passes; sink = accumulated univalue count" sink="$expected"
