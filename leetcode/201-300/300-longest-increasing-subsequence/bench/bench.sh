#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #300.
...
bench_begin id=300 slug=longest-increasing-subsequence group=201-300 \
    title="Longest Increasing Subsequence" \
    workload="build 3000 arrays of 512 elements once, then 24 patience-sorting passes; sink = polynomial hash of every LIS length" sink="$expected"
