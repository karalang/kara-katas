#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #248.
...
bench_begin id=248 slug=strobogrammatic-number-iii group=201-300 \
    title="Strobogrammatic Number III" \
    workload="60k LCG-drawn [low,high] digit-string pairs up to 15 digits, counted by the closed-form + boundary-generation method; sink = accumulated counts" sink="$expected"
