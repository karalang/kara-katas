#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #297.
...
bench_begin id=297 slug=serialize-and-deserialize-binary-tree group=201-300 \
    title="Serialize and Deserialize Binary Tree" \
    workload="build one 200k-node tree, then 24 serialize/deserialize round trips; sink = polynomial hash of every encoded string" sink="$expected"
