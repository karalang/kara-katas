...
bench_begin id=223 slug=rectangle-area group=201-300 \
    title="Rectangle Area" \
    workload="union area of ~1e8 PRNG rectangle pairs via inclusion-exclusion (scalar ALU, min/max/clamp branches)" sink="$expected"
