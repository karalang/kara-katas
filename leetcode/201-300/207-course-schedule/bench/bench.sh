...
bench_begin id=207 slug=course-schedule group=201-300 \
    title="Course Schedule" \
    workload="Kahn topological sort over 8K passes on a 5000-node / 15000-edge CSR graph (BFS traversal kernel)" sink="$expected"
