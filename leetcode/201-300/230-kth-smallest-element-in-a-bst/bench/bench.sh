...
bench_begin id=230 slug=kth-smallest-element-in-a-bst group=201-300 \
    title="Kth Smallest Element in a BST" \
    workload="iterative in-order kth_smallest over a 3000-node BST, 140k queries with varying k (pointer-chasing traversal)" sink="$expected"
