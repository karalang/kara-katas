#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #281.
...
bench_begin id=281 slug=zigzag-iterator group=201-300 \
    title="Zigzag Iterator" \
    workload="64 lists of widely varying length drained end to end, 2200 rounds; sink = position-weighted hash of the interleaved sequence" sink="$expected"
