...
bench_begin id=232 slug=implement-queue-using-stacks group=201-300 \
    title="Implement Queue using Stacks" \
    workload="75M LCG-driven push/pop/peek ops on the two-stack FIFO, size-bounded near 4096 (amortized refill exercised)" sink="$expected"
