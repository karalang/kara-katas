#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #274.
...
bench_begin id=274 slug=h-index group=201-300 \
    title="H-Index" \
    workload="4 citation arrays of 60,000 i64 with different value distributions built once, then 600 punches of copy + stdlib sort + scan; sink=854207143" sink="$expected"
