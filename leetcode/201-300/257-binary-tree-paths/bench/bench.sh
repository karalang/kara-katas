#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #257.
...
bench_begin id=257 slug=binary-tree-paths group=201-300 \
    title="Binary Tree Paths" \
    workload="build one 150k-node random bushy tree once, then 5 rounds of full root-to-leaf path enumeration via the string-extending DFS; sink = positional digest over all rendered paths" sink="$expected"
