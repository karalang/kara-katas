#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #284.
...
bench_begin id=284 slug=peeking-iterator group=201-300 \
    title="Peeking Iterator" \
    workload="320 rounds driving the eager wrapper over 200k elements with two peeks per next; sink = position-weighted hash plus the pull count" sink="$expected"
