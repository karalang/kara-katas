...
bench_begin id=393 slug=utf-8-validation group=301-400 \
    title="UTF-8 Validation" \
    workload="validate 40k x 32-byte records (mostly-valid whole-char fills + ~8% corruption) x 60 passes; data-dependent lead-byte dispatch" sink="$expected"
