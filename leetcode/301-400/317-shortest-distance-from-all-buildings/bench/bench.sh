#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #317.
...
bench_begin id=317 slug=shortest-distance-from-all-buildings group=301-400 \
    title="Shortest Distance from All Buildings" \
    workload="build a 360x360 grid once (20% obstacles, 20 buildings), then 30 one-BFS-per-building passes, one building relocated per pass; sink=masked fold of answers" sink="$expected"
