// Equal-HASH Rust twin — see ../README.md § Benchmarks. Generated from
// top_k_frequent.rs by swapping the default SipHash for the same Fibonacci
// multiply kara uses (runtime/src/map.rs). Not part of the results feed.
...
impl Hasher for FibHasher {
    ...
    fn write(&mut self, bytes: &[u8]) {
        for &b in bytes { self.0 = (self.0 ^ b as u64).wrapping_mul(0x9E37_79B9_7F4A_7C15); }
    }
    fn write_i64(&mut self, i: i64) { self.0 = (i as u64).wrapping_mul(0x9E37_79B9_7F4A_7C15); }
}
