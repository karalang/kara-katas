#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #301.
...
bench_begin id=301 slug=remove-invalid-parentheses group=301-400 \
    title="Remove Invalid Parentheses" \
    workload="build 2000 length-24 strings once, then 64 unique-by-construction repair passes; sink=result count + rolling byte hash" sink="$expected"
