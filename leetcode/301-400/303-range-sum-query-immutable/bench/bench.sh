#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #303.
...
bench_begin id=303 slug=range-sum-query-immutable group=301-400 \
    title="Range Sum Query - Immutable" \
    workload="build a 65536-element prefix array and 200000 query pairs once, then punch 1800 query passes (360M queries); sink=masked running total" sink="$expected"
