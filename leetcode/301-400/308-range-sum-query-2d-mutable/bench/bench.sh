#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #308.
...
bench_begin id=308 slug=range-sum-query-2d-mutable group=301-400 \
    title="Range Sum Query 2D - Mutable" \
    workload="build a 256x256 2D Fenwick tree and a 100000-operation script (half writes, half rectangle reads) once, then punch 54 passes (5.4M operations); sink=masked running total" sink="$expected"
