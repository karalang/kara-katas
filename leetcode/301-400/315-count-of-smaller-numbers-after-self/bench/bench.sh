#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #315.
...
bench_begin id=315 slug=count-of-smaller-numbers-after-self group=301-400 \
    title="Count of Smaller Numbers After Self" \
    workload="generate a 200000-element array once, then punch 24 complete Fenwick-tree passes through it, each swapping two elements chosen from the running checksum so no pass can be hoisted; sink=masked sum of all counts" sink="$expected"
