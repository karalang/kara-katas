#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #307.
...
bench_begin id=307 slug=range-sum-query-mutable group=301-400 \
    title="Range Sum Query - Mutable" \
    workload="build a 65536-element Fenwick tree and a 200000-operation script (half writes, half range reads) once, then punch 110 passes (22M operations); sink=masked running total" sink="$expected"
