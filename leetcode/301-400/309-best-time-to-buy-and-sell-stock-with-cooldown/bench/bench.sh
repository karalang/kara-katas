#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #309.
...
bench_begin id=309 slug=best-time-to-buy-and-sell-stock-with-cooldown group=301-400 \
    title="Best Time to Buy and Sell Stock with Cooldown" \
    workload="generate a 200000-day price series once, then punch 1900 three-state DP passes (380M day-steps), each perturbing one price from the running checksum so no pass can be hoisted; sink=masked running total" sink="$expected"
