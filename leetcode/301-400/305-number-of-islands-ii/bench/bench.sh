#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #305.
...
bench_begin id=305 slug=number-of-islands-ii group=301-400 \
    title="Number of Islands II" \
    workload="shuffle all 65536 cells of a 256x256 grid once, then punch 160 passes that each rebuild the disjoint-set forest and replay every operation (10.5M union-find ops); sink=masked running island count" sink="$expected"
