#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #304.
...
bench_begin id=304 slug=range-sum-query-2d-immutable group=301-400 \
    title="Range Sum Query 2D - Immutable" \
    workload="build a 256x256 matrix and its 257x257 flat prefix table once plus 100000 random rectangles, then punch 1800 query passes (180M queries); sink=masked running total" sink="$expected"
