#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #316.
...
bench_begin id=316 slug=remove-duplicate-letters group=301-400 \
    title="Remove Duplicate Letters" \
    workload="build 4,000,000 drifting letters once, then 100 monotone-stack passes, one letter punched per pass; sink=masked fold of answer bytes" sink="$expected"
