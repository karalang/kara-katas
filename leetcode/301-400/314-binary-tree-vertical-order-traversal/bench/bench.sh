#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #314.
...
bench_begin id=314 slug=binary-tree-vertical-order-traversal group=301-400 \
    title="Binary Tree Vertical Order Traversal" \
    workload="grow 8 random trees of 40000 nodes once, then punch 48 vertical-order traversals through them, each on the tree the running checksum selects, folding every column's size and every value into the checksum; sink=masked running total" sink="$expected"
