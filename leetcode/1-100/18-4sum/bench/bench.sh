#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #18 (4Sum).
...
#
#   four_sum_kara_seq — KARAC_AUTO_PAR=0, single-threaded.
#                        Within-lane comparator vs rust / c / go.
#   four_sum_kara     — default karac build, auto-par on (if it fires).
...
# parallelizes the SAME K=1M outer case-rotation reduction by hand.
build_rayon() {
...
bench_begin id=18 slug=4sum group=1-100 \
    title="4Sum" workload="K=1M case-rotation reduction (M=8 cases, N=16)" \
    sink="$expected"
...
rt_cmd --lang kara --approach four_sum --lane seq --mode codegen \
    --name "kara ${STEM} (seq, KARAC_AUTO_PAR=0)" --cmd "./target/${STEM}_kara_seq"
rt_cmd --lang rust --approach four_sum --lane seq --mode native \
    --name "rust ${STEM}" --cmd "./target/${STEM}"
ovf_rt_cmds "${STEM}" "four_sum" seq
rt_cmd --lang c --approach four_sum --lane seq --mode native \
    --name "c    ${STEM}" --cmd "./target/${STEM}_c"
rt_cmd --lang go --approach four_sum --lane seq --mode native \
...
rt_cmd --lang kara --approach four_sum --lane par --mode codegen \
    --name "kara ${STEM} (auto-par default)" --cmd "./target/${STEM}_kara"
rt_cmd --lang c --approach four_sum --lane par --mode native \
    --name "c    ${STEM} (pthreads — metal floor)" --cmd "./target/${STEM}_c_par"
rt_cmd --lang rust --approach four_sum --lane par --mode native \
    --name "rust ${STEM} (rayon par_iter)" --cmd "./target/${STEM}_rayon"
rt_cmd --lang go --approach four_sum --lane par --mode native \
...
rt_cmd --lang python --approach four_sum --lane seq --mode interp \
...
ce_cmd --lang kara --approach four_sum --mode codegen \
...
ce_cmd --lang rust --approach four_sum --mode native \
    --prepare "rm -f target/${STEM}" \
    --name "rustc -O ${STEM}.rs" --cmd "rustc -O ${STEM}.rs -o target/${STEM}"
ce_cmd --lang c --approach four_sum --mode native \
...
echo
echo "=== binary size ==="
size_put --lang kara --approach four_sum --lane seq --mode codegen --path "target/${STEM}_kara_seq"
size_put --lang kara --approach four_sum --lane par --mode codegen --path "target/${STEM}_kara"
size_put --lang c    --approach four_sum --lane par --mode native  --path "target/${STEM}_c_par"
size_put --lang rust --approach four_sum --lane par --mode native  --path "target/${STEM}_rayon"
size_put --lang go   --approach four_sum --lane par --mode native  --path "target/${STEM}_go_par"
size_put --lang rust --approach four_sum --lane seq --mode native  --path "target/${STEM}"
size_put --lang c    --approach four_sum --lane seq --mode native  --path "target/${STEM}_c"
size_put --lang go   --approach four_sum --lane seq --mode native  --path "target/${STEM}_go_seq"

echo
echo "=== runtime memory (peak) ==="
mem_put --lang kara --approach four_sum --lane seq --mode codegen --bytes "$(mem_peak ./target/${STEM}_kara_seq)"
mem_put --lang kara --approach four_sum --lane par --mode codegen --bytes "$(mem_peak ./target/${STEM}_kara)"
mem_put --lang c    --approach four_sum --lane par --mode native  --bytes "$(mem_peak ./target/${STEM}_c_par)"
mem_put --lang rust --approach four_sum --lane par --mode native  --bytes "$(mem_peak ./target/${STEM}_rayon)"
mem_put --lang go   --approach four_sum --lane par --mode native  --bytes "$(mem_peak ./target/${STEM}_go_par)"
mem_put --lang rust --approach four_sum --lane seq --mode native  --bytes "$(mem_peak ./target/${STEM})"
mem_put --lang c    --approach four_sum --lane seq --mode native  --bytes "$(mem_peak ./target/${STEM}_c)"
mem_put --lang go   --approach four_sum --lane seq --mode native  --bytes "$(mem_peak ./target/${STEM}_go_seq)"
