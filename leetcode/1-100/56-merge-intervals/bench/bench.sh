...
ovf_rt_cmds "${STEM}" "merge_intervals" seq
...
rt_cmd --lang c --approach merge_intervals --lane par --mode native \
    --name "c    ${STEM} (pthreads — metal floor)" --cmd "./target/${STEM}_c_par"
rt_cmd --lang rust --approach merge_intervals --lane par --mode native \
    --name "rust ${STEM} (rayon par_iter)" --cmd "./target/${STEM}_rayon"
rt_cmd --lang go --approach merge_intervals --lane par --mode native \
...
size_put --lang c    --approach merge_intervals --lane par --mode native  --path "target/${STEM}_c_par"
size_put --lang rust --approach merge_intervals --lane par --mode native  --path "target/${STEM}_rayon"
size_put --lang go   --approach merge_intervals --lane par --mode native  --path "target/${STEM}_go_par"
...
mem_put --lang c    --approach merge_intervals --lane par --mode native  --bytes "$(mem_peak ./target/${STEM}_c_par)"
mem_put --lang rust --approach merge_intervals --lane par --mode native  --bytes "$(mem_peak ./target/${STEM}_rayon)"
mem_put --lang go   --approach merge_intervals --lane par --mode native  --bytes "$(mem_peak ./target/${STEM}_go_par)"
