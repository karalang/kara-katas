...
// Rust mirror of bench/spiral_matrix_ii.kara. Same M=9 rotated sizes
// (n=12..20), K=180k, boundary-shrinking generator over a nested
// Vec<Vec<i64>>, position-weighted checksum, and sink — see that file's
