...
isa_build_c    permutation_sequence.c
isa_build_rust permutation_sequence.rs
...
isa_build_c    permutation_sequence_nextperm.c
isa_build_rust permutation_sequence_nextperm.rs
...
isa_rt_cmds "permutation_sequence" seq factorial "$(./target/ps_fact_kara_seq)"
...
isa_rt_cmds "permutation_sequence_nextperm" seq nextperm "$(./target/ps_next_kara_seq)"
