#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #29.
...
bench_begin id=29 slug=divide-two-integers group=1-100 \
    title="Divide Two Integers" workload="N=5M divides, LCG inputs, small divisors" \
    sink="$expected"
