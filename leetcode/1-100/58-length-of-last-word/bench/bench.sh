...
bench_begin id=58 slug=length-of-last-word group=1-100 \
    title="Length of Last Word" \
    workload="reverse-scan last-word length over 6.5M end positions in a 4M letters+spaces buffer (build-once + punch)" sink="$expected"
