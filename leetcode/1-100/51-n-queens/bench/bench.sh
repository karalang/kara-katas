#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #51.
...
bench_begin id=51 slug=n-queens group=1-100 \
    title="N-Queens" workload="count all solutions for n=8..13 (91760 total) via bitmask backtracking, weighted-checksum sink" \
    sink="$expected"
