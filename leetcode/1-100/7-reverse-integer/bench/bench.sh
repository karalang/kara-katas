...
# parallelizes the SAME K=50M outer reduction by hand.
build_rayon() {
...
rt_cmd --lang rust_ovf --approach reverse --lane seq --mode native \
    --name "rust reverse (overflow-checks=on, equal-safety)" --cmd "./target/${STEM}_ovf"
...
rt_cmd --lang c --approach reverse --lane par --mode native \
    --name "c    ${STEM} (pthreads — metal floor)" --cmd "./target/${STEM}_c_par"
rt_cmd --lang rust --approach reverse --lane par --mode native \
    --name "rust ${STEM} (rayon par_iter)" --cmd "./target/${STEM}_rayon"
rt_cmd --lang go --approach reverse --lane par --mode native \
...
size_put --lang c    --approach reverse --lane par --mode native  --path "target/${STEM}_c_par"
size_put --lang rust --approach reverse --lane par --mode native  --path "target/${STEM}_rayon"
size_put --lang go   --approach reverse --lane par --mode native  --path "target/${STEM}_go_par"
...
mem_put --lang c    --approach reverse --lane par --mode native  --bytes "$(mem_peak ./target/${STEM}_c_par)"
mem_put --lang rust --approach reverse --lane par --mode native  --bytes "$(mem_peak ./target/${STEM}_rayon)"
mem_put --lang go   --approach reverse --lane par --mode native  --bytes "$(mem_peak ./target/${STEM}_go_par)"
