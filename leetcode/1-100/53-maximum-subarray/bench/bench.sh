...
bench_begin id=53 slug=maximum-subarray group=1-100 \
    title="Maximum Subarray" workload="Kadane over a batch of 120000 LCG-generated length-1000 arrays, i64 sink of per-array answers" \
    sink="$expected"
