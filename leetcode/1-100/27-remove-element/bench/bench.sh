#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #27.
...
bench_begin id=27 slug=remove-element group=1-100 \
    title="Remove Element" workload="N=2M ~50% match, K=10 compactions" \
    sink="$expected"
