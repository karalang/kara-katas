...
#
#   vertical_kara_seq — KARAC_AUTO_PAR=0, single-threaded.
#                       Within-lane comparator vs rust / c / go.
#   vertical_kara     — default karac build, auto-par on (if it fires).
...
rt_cmd --lang c --approach vertical --lane par --mode native \
    --name "c    ${STEM} (pthreads — metal floor)" --cmd "./target/${STEM}_c_par"
rt_cmd --lang rust --approach vertical --lane par --mode native \
    --name "rust ${STEM} (rayon par_iter)" --cmd "./target/${STEM}_rayon"
rt_cmd --lang go --approach vertical --lane par --mode native \
...
size_put --lang c    --approach vertical --lane par --mode native  --path "target/${STEM}_c_par"
size_put --lang rust --approach vertical --lane par --mode native  --path "target/${STEM}_rayon"
size_put --lang go   --approach vertical --lane par --mode native  --path "target/${STEM}_go_par"
...
mem_put --lang c    --approach vertical --lane par --mode native  --bytes "$(mem_peak ./target/${STEM}_c_par)"
mem_put --lang rust --approach vertical --lane par --mode native  --bytes "$(mem_peak ./target/${STEM}_rayon)"
mem_put --lang go   --approach vertical --lane par --mode native  --bytes "$(mem_peak ./target/${STEM}_go_par)"
