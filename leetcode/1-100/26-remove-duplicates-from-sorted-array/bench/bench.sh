#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #26.
...
bench_begin id=26 slug=remove-duplicates-from-sorted-array group=1-100 \
    title="Remove Duplicates from Sorted Array" workload="N=2M ~50% dups, K=10 dedups" \
    sink="$expected"
