#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #53.
...
bench_begin id=54 slug=spiral-matrix group=1-100 \
    title="Spiral Matrix" workload="Boundary-shrinking spiral over a batch of 200000 LCG-filled 24x24 matrices, i64 sink of per-matrix position-weighted checksums" \
    sink="$expected"
