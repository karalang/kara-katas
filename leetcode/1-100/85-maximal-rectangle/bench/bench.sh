...
bench_begin id=85 slug=maximal-rectangle group=1-100 \
    title="Maximal Rectangle" \
    workload="histogram + monotonic-stack maximal rectangle over a 70x70 0/1 matrix x 11K passes (build-once + punch)" sink="$expected"
