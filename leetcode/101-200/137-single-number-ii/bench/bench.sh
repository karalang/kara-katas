#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #137.
...
bench_begin id=137 slug=single-number-ii group=101-200 \
    title="Single Number II" \
    workload="4 arrays of 120,001 i64 built once (30k values interleaved 3x + one loner), then 40 punches; each punch runs BOTH bit tricks (ones/twos FSM and per-bit count mod 3) and cross-checks them; sink=79998760" sink="$expected"
