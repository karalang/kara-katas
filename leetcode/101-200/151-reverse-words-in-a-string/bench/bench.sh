#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #151.
...
bench_begin id=151 slug=reverse-words-in-a-string group=101-200 \
    title="Reverse Words in a String" \
    workload="reverse-words over a large multi-word byte buffer x passes, rolling-hash checksum sink" sink="$expected"
