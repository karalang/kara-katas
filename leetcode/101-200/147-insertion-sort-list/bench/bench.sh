#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #147.
...
bench_begin id=147 slug=insertion-sort-list group=101-200 \
    title="Insertion Sort List" \
    workload="insertion-sort an index-pool linked list (N nodes) x passes, position-weighted checksum sink" sink="$expected"
