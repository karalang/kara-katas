...
bench_begin id=156 slug=binary-tree-upside-down group=101-200 \
    title="Binary Tree Upside Down" \
    workload="iterative flip of a 50000-node left-spine tree (index pool) x 1100 punched passes; per-pass link reset + pointer rewire + rolling-checksum fold of the result" sink="$expected"
