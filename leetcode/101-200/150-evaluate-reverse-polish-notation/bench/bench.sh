#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #150.
...
bench_begin id=150 slug=evaluate-reverse-polish-notation group=101-200 \
    title="Evaluate Reverse Polish Notation" \
    workload="stack-machine eval of a large valid RPN token stream x K punches, modular result sum sink" sink="$expected"
