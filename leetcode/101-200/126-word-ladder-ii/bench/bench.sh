#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #126.
...
bench_begin id=126 slug=word-ladder-ii group=101-200 \
    title="Word Ladder II" \
    workload="all 3,125 five-letter words over {a..e} generated once, then 24 punches of BFS predecessor-graph + DFS enumeration of every shortest ladder; Map[String, Vec[String]] read-modify-written per edge; sink=125559906" sink="$expected"
