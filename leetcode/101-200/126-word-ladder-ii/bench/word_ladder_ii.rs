...
//
// This lane uses Rust's DEFAULT HashMap hasher (SipHash-1-3). Kara's
// Map[String, _] uses FxHash; the equal-hash sibling is
// word_ladder_ii_fasthash.rs — see ../README.md § Benchmarks.
...
fn find_ladders(begin: String, end: String, words: &Vec<String>) -> LadderResult {
    ...
    while !cur.is_empty() && !found {
        let mut in_next: HashMap<String, i64> = HashMap::new();
