...
bench_begin id=161 slug=one-edit-distance group=101-200 \
    title="One Edit Distance" \
    workload="is_one_edit over 4000 string pairs (len 48, alphabet 26) x 3000 punched reps; data-dependent early-exit scan" sink="$expected"
