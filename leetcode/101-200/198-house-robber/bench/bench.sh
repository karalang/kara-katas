...
bench_begin id=198 slug=house-robber group=101-200 \
    title="House Robber" \
    workload="O(1)-space rob() DP over a 5000-house PRNG array x 90000 punched passes (loop-carried max recurrence, one house flipped per pass)" sink="$expected"
