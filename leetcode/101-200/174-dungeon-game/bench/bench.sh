...
bench_begin id=174 slug=dungeon-game group=101-200 \
    title="Dungeon Game" \
    workload="build a 200x200 signed PRNG dungeon once, then 2000 backward min-health DP passes with a per-pass cell sign-flip punch; sink=sum of dp[0][0] over passes" sink="$expected"
