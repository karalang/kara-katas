...
bench_begin id=139 slug=word-break group=101-200 \
    title="Word Break" \
    workload="prefix-DP word break over 2.2M random windows into a build-once string; dict is a SET (flat stamped base-A table; C hand-rolls it)" sink="$expected"
