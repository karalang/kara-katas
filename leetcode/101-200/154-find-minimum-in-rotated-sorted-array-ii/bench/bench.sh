#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #154.
...
bench_begin id=154 slug=find-minimum-in-rotated-sorted-array-ii group=101-200 \
    title="Find Minimum in Rotated Sorted Array II" \
    workload="binary-search min of many PRNG rotated-with-duplicates arrays, sum of mins sink" sink="$expected"
