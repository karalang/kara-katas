#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #191.
...
bench_begin id=191 slug=number-of-1-bits group=101-200 \
    title="Number of 1 Bits" \
    workload="Brian Kernighan popcount, N=4M K=40" sink="$expected"
