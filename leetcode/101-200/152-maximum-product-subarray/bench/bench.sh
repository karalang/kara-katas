#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #152.
...
bench_begin id=152 slug=maximum-product-subarray group=101-200 \
    title="Maximum Product Subarray" \
    workload="running max/min product DP scan, N=2M K=10" sink="$expected"
