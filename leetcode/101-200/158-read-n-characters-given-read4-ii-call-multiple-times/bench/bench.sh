...
bench_begin id=158 slug=read-n-characters-given-read4-ii-call-multiple-times group=101-200 \
    title="Read N Characters Given Read4 II - Call multiple times" \
    workload="read(3) with a persistent 4-char leftover buffer draining a 50000-char source (lossless) x 2600 punched rewinds; rolling-checksum fold over chars read" sink="$expected"
