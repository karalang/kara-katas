#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #169.
...
bench_begin id=169 slug=majority-element group=101-200 \
    title="Majority Element" \
    workload="Boyer-Moore majority vote, N=10M K=20" sink="$expected"
