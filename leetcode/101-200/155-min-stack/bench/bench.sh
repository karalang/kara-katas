#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #155.
...
bench_begin id=155 slug=min-stack group=101-200 \
    title="Min Stack" \
    workload="PRNG push/pop/getMin/top op sequence on a min-stack, accumulated getMin/top sink" sink="$expected"
