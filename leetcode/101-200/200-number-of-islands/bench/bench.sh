...
bench_begin id=200 slug=number-of-islands group=101-200 \
    title="Number of Islands" \
    workload="iterative stack flood-fill island count over an 80x80 PRNG 0/1 grid x 13000 passes, grid restored from a persistently-punched master each pass (data-dependent stack growth, non-vectorizing)" sink="$expected"
