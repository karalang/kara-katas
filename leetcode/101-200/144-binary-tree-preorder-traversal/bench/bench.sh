...
bench_begin id=144 slug=binary-tree-preorder-traversal group=101-200 \
    title="Binary Tree Preorder Traversal" \
    workload="iterative preorder (explicit index-pool stack) over a 50k-node BST x 400 passes, pointer-chase" sink="$expected"
