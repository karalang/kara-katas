...
bench_begin id=189 slug=rotate-array group=101-200 \
    title="Rotate Array" \
    workload="triple-reversal in-place rotate of a 30000-element PRNG array x 4000 fresh-PRNG-amount passes, loop-carried polynomial checksum folded each pass" sink="$expected"
