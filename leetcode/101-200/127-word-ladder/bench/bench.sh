#!/usr/bin/env bash
# Wall-clock comparison across implementations of LeetCode #127.
...
bench_begin id=127 slug=word-ladder group=101-200 \
    title="Word Ladder" \
    workload="all 3,125 five-letter words over {a..e} generated once, then 17 BFS punches; each punch builds a Map[String,i64] of the list and generates ~390k fresh 5-byte Strings for String-keyed lookups; sink=755481159" sink="$expected"
