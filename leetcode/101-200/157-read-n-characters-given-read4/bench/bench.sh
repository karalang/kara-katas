...
bench_begin id=157 slug=read-n-characters-given-read4 group=101-200 \
    title="Read N Characters Given Read4" \
    workload="read(7) state machine draining a 50000-char buffer x 3200 punched rewinds (lossy #157 read4); rolling-checksum fold over chars read" sink="$expected"
