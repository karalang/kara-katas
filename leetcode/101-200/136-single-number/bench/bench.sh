...
bench_begin id=136 slug=single-number group=101-200 \
    title="Single Number" \
    workload="XOR-fold of a 280001-element pairs+unique array x 3400 passes (build-once + punch); sink=fold total" sink="$expected"
