...
bench_begin id=172 slug=factorial-trailing-zeroes group=101-200 \
    title="Factorial Trailing Zeroes" \
    workload="trailing_zeroes summed over n in 0..35M (repeated /5 factor-count loop; scalar, non-vectorizing)" sink="$expected"
