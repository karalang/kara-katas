...
bench_begin id=140 slug=word-break-ii group=101-200 \
    title="Word Break II" \
    workload="exponential-backtracking segmentation COUNT over 80K short random inputs (dict is a SET; flat stamped base-A table)" sink="$expected"
