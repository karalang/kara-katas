...
bench_begin id=142 slug=linked-list-cycle-ii group=101-200 \
    title="Linked List Cycle II" \
    workload="Floyd two-phase cycle-ENTRY detection over 1000 index-pool lists x 3000 perturbed passes (pointer-chasing)" sink="$expected"
