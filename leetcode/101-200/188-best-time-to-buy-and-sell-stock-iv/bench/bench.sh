...
bench_begin id=188 slug=best-time-to-buy-and-sell-stock-iv group=101-200 \
    title="Best Time to Buy and Sell Stock IV" \
    workload="O(n*k) two-array transaction DP over a 2000-price PRNG array x 5000 rounds, fresh PRNG k (<n/2) + one price punch per round (loop-carried max recurrence)" sink="$expected"
