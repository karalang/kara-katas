...
bench_begin id=145 slug=binary-tree-postorder-traversal group=101-200 \
    title="Binary Tree Postorder Traversal" \
    workload="iterative postorder (two explicit index-pool stacks) over a 50k-node BST x 250 passes, pointer-chase" sink="$expected"
