...
bench_begin id=143 slug=reorder-list group=101-200 \
    title="Reorder List" \
    workload="in-place L0->Ln->L1->... reorder of a 100K-node index-pool list x 1000 perturbed passes; position-weighted checksum" sink="$expected"
