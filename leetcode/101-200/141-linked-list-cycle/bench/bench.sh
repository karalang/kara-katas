...
bench_begin id=141 slug=linked-list-cycle group=101-200 \
    title="Linked List Cycle" \
    workload="Floyd tortoise/hare cycle detection over 1000 index-pool lists x 3000 perturbed passes (pointer-chasing)" sink="$expected"
