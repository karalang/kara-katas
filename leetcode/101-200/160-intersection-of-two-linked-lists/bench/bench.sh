...
bench_begin id=160 slug=intersection-of-two-linked-lists group=101-200 \
    title="Intersection of Two Linked Lists" \
    workload="two-pointer intersection-find over a 100003-node scrambled (coprime-stride) chain, two suffix lists per pass x 280 passes; cache-hostile pointer-chase walks" sink="$expected"
